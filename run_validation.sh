#!/bin/bash
#SBATCH --job-name=validate-no-probit
#SBATCH --output=logs/validate_no_probit_%j.out
#SBATCH --error=logs/validate_no_probit_%j.err
#SBATCH --nodes=1
...
echo "================================================================"
echo "VALIDATION RUN: No Probit Transformation"
echo "================================================================"
...
torchrun \
    ...
    --config configs/validate_no_probit.yaml \
